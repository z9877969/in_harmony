...
// import { AboutPageModelUA, AboutPageModelUK } from './AboutPageModels.js';
...
//     const aboutPageDataUA = new AboutPageModelUA({
//       local: 'ua',
//       route: 'about',
//       sections_list: sections,
//     });
//     await AboutPageModelUA.create(aboutPageDataUA);
//     console.log('📦  Page (UA) data inserted');

//     const aboutPageDataUK = new AboutPageModelUK({
//       local: 'uk',
//       route: 'about',
//       sections_list: sectionsUk,
//     });

//     await AboutPageModelUK.create(aboutPageDataUK);
